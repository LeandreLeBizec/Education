...
class EAN13:
    ...
    def cle(self):
        res = 0
        for k in range(0, len(self.code)-1, 2):
            res += int(self.code[k]) * 1 + int(self.code[k + 1]) * 3
        res = 10 - res % 10
        return str(res)
...
if __name__ == "__main__":
    ...
    lst = "3333299304137", "3344428069940", "3475001049988", "3475001052476", \
          "3475001054487", "3700724902778", "5051889599852", "5051889606659", "5051889606666", "7321950126194"
